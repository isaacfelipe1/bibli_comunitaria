        ...
        <form class="form-cadastro" method="post" enctype="multipart/form-data">
            ...
            <div class="div-label-input">
                ...
                <div class="label-input">
                    ...
                    <div>
                        <textarea style="margin: 0.5rem 0 0 0; width: 35vw; height: 15vh; border: 1px solid rgba(190, 186, 186, 0.726); margin-bottom: 2rem; resize: none;" type="text" name="observacao"></textarea>
                    </div>
                </div>
                ...
                <div class="label-input">
                    ...
                    <div>
                        <input id="campo" style="margin: 0.5rem 0 0 0;width: 30vw" type="file" name="foto" required>
                    </div>
                </div>
            </div>
