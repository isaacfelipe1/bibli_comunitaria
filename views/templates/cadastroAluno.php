    ...
    function formatPhoneNumber(input) {
        ...
        <div class="div-label-input">
            ...
            <div class="label-input">
                ...
                <div>
                    <input id="campo" style="margin: 0.5rem 0 0 0;width: 35vw" style="width:50vh"  type="text" name="responsavel" placeholder="Ex: Martha Wayne" required>
                </div>
            </div>
            ...
            <div class="label-input">
                ...
                <div>
                    <input id="campo" style="margin: 0.5rem 0 0 0;width: 35vw" style="width:50vh"  type="text" name="escola" placeholder="Ex: Martha Wayne" required>
                </div>
            </div>
            ...
            <div class="label-input">
                ...
                <div>
                    <input id="campo" style="margin: 0.5rem 0 0 0;width: 20vw" style="width:20vh"  type="text" name="turma" placeholder="Ex: 6 ano C" required>
                </div>
            </div>
            ...
            <!--    </div>-->
            <!--    <div>-->
            <!--        <input id="campo" style="margin: 0.5rem 0 0 0;width: 20vw" style="width:20vh"  type="text" name="serie" placeholder="Ex: Martha Wayne" required>-->
            <!--    </div>-->
            <!--</div>-->
            ...
            <!--    </div>-->
            <!--    <div>-->
            <!--        <input id="campo" style="margin: 0.5rem 0 0 0;width: 20vw" style="width:50vh"  type="text" name="disponibilidade" placeholder="Ex: Martha Wayne" required>-->
            <!--    </div>-->
            <!--</div>-->
